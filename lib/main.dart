...
Future<void> main() async {
  ...
  DependecyService.getIt.registerLazySingleton<TagsMobx>(() => TagsMobx());
  DependecyService.getIt.registerSingleton<FolderMobx>(FolderMobx());

  DependecyService.getIt.registerLazySingleton<CreateFolderDatabase>(
      () => CreateFolderDatabase());
  DependecyService.getIt.get<FolderMobx>().getAllFolders();
  ...
  DependecyService.getIt.get<TagsMobx>().copyModels = DependecyService.getIt
      ...
      .models
      .map<TagsModel>(
          (e) => TagsModel(tags_id: e.tags_id, name: e.name).copyWith())
      .toList();
